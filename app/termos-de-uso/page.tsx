    ...
    <div className="min-h-screen bg-white dark:bg-abyss">
      ...
      <main className="relative overflow-hidden pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-display text-4xl font-bold text-zinc-900 dark:text-mist mb-8">Termos de Uso</h1>

          <div className="space-y-8 text-zinc-700 dark:text-mist-soft leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">1. Aceitação dos Termos</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">2. Uso do Site</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">3. Propriedade Intelectual</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">4. Limitação de Responsabilidade</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">5. Modificações</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">6. Contato</h2>
              <p>
