    ...
    <div className="min-h-screen bg-white dark:bg-abyss">
      ...
      <main className="relative overflow-hidden pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-display text-4xl font-bold text-zinc-900 dark:text-mist mb-8">Política de Cookies</h1>

          <div className="space-y-8 text-zinc-700 dark:text-mist-soft leading-relaxed">
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">1. O que são Cookies?</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">2. Como Usamos os Cookies?</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">3. Tipos de Cookies Utilizados</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">4. Gerenciamento de Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-mist mb-4">5. Contato</h2>
              <p>
